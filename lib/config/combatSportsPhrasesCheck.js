// lib/codeChecks/combatSportsPhrasesCheck.js
// Zweck:
// - Scannt Titel/Beschreibung/Video-Titel nach COMBAT_SPORTS_PHRASES
// - ok=false wenn hitsDistinct >= threshold (also "zu viel Kampfsport")
...
export function combatSportsPhrasesCheck(
  doc,
  phrasesArray,
  distinctThreshold = 2,
  opts = {}
